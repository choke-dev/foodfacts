export const STATIC_HOST = 'https://corsproxy.io/?url=https://static.openfoodfacts.org';
export const API_HOST = import.meta.env.VITE_OFF_BASE_URL || 'https://corsproxy.io/?url=https://world.openfoodfacts.org';
export const SEARCH_URL = `${API_HOST}/api/v2/search`;
export const IMAGE_HOST = 'https://corsproxy.io/?url=https://images.openfoodfacts.org';
