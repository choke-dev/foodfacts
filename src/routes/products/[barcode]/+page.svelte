	...
	<div class="flex flex-row gap-8">
		...
		<div class="flex flex-col w-2/3">
			<div class="flex justify-between items-start mb-4">
				<div class="grow">
					<h1 class="text-2xl font-bold md:text-4xl mb-4">
					...
					<!-- <div class="flex flex-wrap gap-4 mb-6">
						<div class="w-[120px] h-[70px] flex-shrink-0 overflow-hidden rounded-lg bg-white shadow">
				...
				<div class="dropdown dropdown-end">
					...
					<ul tabindex="0" class="dropdown-content z-[1] menu p-2 shadow bg-base-100 rounded-box w-52">
						<li>
							<a href={'https://corsproxy.io/?url=https://world.openfoodfacts.org/product/' + product.code} target="_blank" rel="noopener noreferrer">
								See on OpenFoodFacts
							</a>
						</li>
						<li>
							<a href={`/products/${product.code}/edit`}>
								Edit Product
							</a>
						</li>
					</ul>
			...
			<div class="grid grid-cols-[max-content_1fr] gap-x-4 gap-y-1">
				...
				<span class="flex flex-wrap gap-1">
					{#await data.taxo.categories}
						Loading...
					{:then categories}
						{#each product.categories_tags.slice(0, showAllCategories ? undefined : 5) as tag (tag)}
							<a
